...
//  - 시작일이 오늘로부터 1달 이내(이미 시작한 것도 포함, 즉 start_date <= 오늘+1달) — 2026-08-23에
//    2주로 좁혔다가, 너무 적게 보인다는 사용자 피드백으로 2026-08-25에 원래대로 1달로 되돌림
//  - 마감일이 2주 이내 지난 것까지(deadline_date >= 오늘-2주) — 2026-08-23에 1주로 좁혔다가
//    마찬가지로 2026-08-25에 원래대로 2주로 되돌림
...
// 지금은 수동 실행).
const START_WINDOW_DAYS_AHEAD = 30; // 1달
const CLOSED_WINDOW_DAYS_BEHIND = 14; // 2주
